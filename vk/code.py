...
datafile = open('C:\\Users\\yuram\\Desktop\\project\\vk\\matrix.csv', 'r') #### Путь к файлу CSV
...
for i in range(N):
    print(str(i+1)+") ("+all[i][2]+") https://vk.com/id"+str(int(all[i][1]))+" : "+str(round((all[i][0]*100), 2))+"%")
input()
